  ...
  return data ? (
    <div className='relative'>
      ...
      <div className='mx-5 max-w-3xl md:mx-auto my-10 mt-6'>
        <img src={data.image} alt="" className='w-full max-w-xl h-[220px] sm:h-[280px] md:h-[320px] mx-auto object-cover
        rounded-3xl mb-5'/>
      ...
      <div className='mt-14 mb-10 max-w-3xl mx-auto'>
        ...
        <div className='flex flex-col gap-4'>
          {comments.map((item, index) => (
            <div key={item._id} className='relative bg-primary/2 border 
