...
const AddBlog = () => {
  ...
  const onSubmitHandler = async (e) => {
    ...
    try {
      ...
      // The submitted blog is created as an unpublished draft.
      const blog = {
      ...
      >
        ...
        <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
          ...
          <button
            ...
            text-xs text-white bg-black/70
            px-4 py-1.5 rounded
        ...
        <div className='mt-4'>
          <p className='text-sm text-gray-500'>
            This blog will be submitted for administrator review before it is published.
          </p>
        </div>
